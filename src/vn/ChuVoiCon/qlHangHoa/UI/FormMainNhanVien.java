...
//	}
	...
	public FormMainNhanVien(String a) {
		...
		contentPane.setBorder(new TitledBorder(null, "abc", TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	private JScrollPane getScrollPane() {
		if (scrollPane == null) {
			...
			scrollPane.setBounds(9, 123, 219, 291);
	...
	private JLabel getLblXinCho() {
		if (lblXinCho == null) {
			...
			lblXinCho.setBounds(511, 11, 60, 14);
		}
		return lblXinCho;
	}
	...
	private JLabel getLblMNhnVin() {
		if (lblMNhnVin == null) {
			...
			lblMNhnVin.setBounds(248, 140, 99, 23);
		}
		return lblMNhnVin;
	}
	private JLabel getLblTnNhnVin() {
		if (lblTnNhnVin == null) {
			...
			lblTnNhnVin.setBounds(248, 174, 99, 23);
		}
		return lblTnNhnVin;
	}
	private JLabel getLblTnNhnVin_1() {
		if (lblTnNhnVin_1 == null) {
			...
			lblTnNhnVin_1.setBounds(520, 174, 92, 23);
		}
	...
	private JLabel getLblPhi() {
		if (lblPhi == null) {
			...
			lblPhi.setBounds(248, 208, 99, 23);
		}
		return lblPhi;
	}
	private JLabel getLblaCh() {
		if (lblaCh == null) {
			...
			lblaCh.setBounds(520, 208, 77, 23);
		}
		return lblaCh;
	}
	private JLabel getLblaCh_1() {
		if (lblaCh_1 == null) {
			...
			lblaCh_1.setBounds(248, 242, 99, 23);
		}
		return lblaCh_1;
	}
	private JLabel getLblMPhngBan() {
		if (lblMPhngBan == null) {
			...
			lblMPhngBan.setBounds(248, 381, 99, 23);
		}
		return lblMPhngBan;
	}
	private JLabel getLblChcV() {
		if (lblChcV == null) {
			...
			lblChcV.setBounds(520, 381, 59, 23);
		}
		return lblChcV;
	}
	private JLabel getLblTnhTrngNv() {
		if (lblTnhTrngNv == null) {
			...
			lblTnhTrngNv.setBounds(248, 347, 99, 23);
		}
		return lblTnhTrngNv;
	}
	private JLabel getLabel() {
		if (label == null) {
			...
			label.setBounds(520, 347, 59, 23);
		}
		return label;
	}
	private JLabel getLblSinThoi() {
		if (lblSinThoi == null) {
			lblSinThoi = new JLabel("\u0110i\u1EC7n tho\u1EA1i li\u00EAn h\u1EC7");
			lblSinThoi.setBounds(248, 276, 99, 23);
		}
		return lblSinThoi;
	}
	private JTextField getTextField_1() {
		if (textField_1 == null) {
			...
			textField_1.setBounds(352, 140, 147, 23);
	...
	private JTextField getTextField_2() {
		if (textField_2 == null) {
			...
			textField_2.setBounds(352, 175, 147, 23);
		}
		return textField_2;
	}
	private JTextField getTextField_3() {
		if (textField_3 == null) {
			...
			textField_3.setBounds(352, 209, 147, 23);
		}
		return textField_3;
	}
	private JTextField getTextField_4() {
		if (textField_4 == null) {
			...
			textField_4.setBounds(352, 243, 422, 23);
		}
		return textField_4;
	}
	private JTextField getTextField_5() {
		if (textField_5 == null) {
			...
			textField_5.setBounds(352, 277, 147, 23);
		}
		return textField_5;
	}
	private JTextField getTextField_6() {
		if (textField_6 == null) {
			...
			textField_6.setBounds(352, 381, 147, 23);
		}
		return textField_6;
	}
	private JTextField getTextField_7() {
		if (textField_7 == null) {
			...
			textField_7.setBounds(352, 347, 147, 23);
		}
		return textField_7;
	}
	private JTextField getTextField_8() {
		if (textField_8 == null) {
			...
			textField_8.setBounds(622, 174, 152, 23);
		}
		return textField_8;
	}
	private JTextField getTextField_9() {
		if (textField_9 == null) {
			...
			textField_9.setBounds(622, 208, 152, 23);
		}
		return textField_9;
	}
	private JTextField getTextField_10() {
		if (textField_10 == null) {
			...
			textField_10.setBounds(622, 381, 152, 23);
		}
		return textField_10;
	}
	private JTextField getTextField_11() {
		if (textField_11 == null) {
			...
			textField_11.setBounds(622, 347, 152, 23);
		}
		return textField_11;
	}
	private JPanel getPanel() {
		if (panel == null) {
			panel = new JPanel();
			panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Th\u00F4ng Tin C\u00E1 nh\u00E2n", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
			panel.setBounds(238, 123, 557, 188);
	...
	private JPanel getPanel_1_1() {
		if (panel_1 == null) {
			panel_1 = new JPanel();
			panel_1.setBorder(new TitledBorder(null, "Th\u00F4ng Tin Chi Ti\u1EBFt", TitledBorder.LEADING, TitledBorder.TOP, null, null));
			panel_1.setBounds(238, 322, 557, 95);
		}
		return panel_1;
	}
}
