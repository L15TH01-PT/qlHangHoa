...
public class ChiTietSanPhamDAO extends Connect{
	...
	public int add(String masp, String maloai, String mancc, String tensp, String noidung, int baohanh, String dvt) {		
		try {
	...
	public int edit(String masp, String maloai, String mancc, String tensp, String noidung, int baohanh, String dvt) {
		try {
			PreparedStatement ps = getPreparedStatement("UPDATE chi_tiet_san_pham SET id_loai = ?,id_ncc=?,ten_sp=?,noi_dung=?,bao_hanh=?,don_vi_tinh=? WHERE id_sp = ?");
