...
public class phieu_nhapDAO extends Connect {
	// Collum sql
		...
		protected nhap_kho convertData(ResultSet rs) throws SQLException {
			...
			r.setMa_phieu_nhap(rs.getString(ma_phieu_nhap));
		...
		protected void addIDParmater(CallableStatement cstm, String id)
				throws SQLException {
			cstm.setString(1, id);
		}
		...
		protected void addAllParmater(CallableStatement cstm, nhap_kho data)
				throws SQLException {
			cstm.setString(1, data.getMa_phieu_nhap());
